...
const divCTA = (
    <div className="relative z-10 w-[95%] sm:w-[90%] md:w-[70%] lg:w-[60%] flex flex-col gap-6 text-left rounded-2xl py-8 px-6 md:py-16 md:px-12 bg-purple-CTA-bg shadow-2xl mx-auto my-16 backdrop-blur-sm">
        ...
        <p className="text-base text-text font-description">Experience the future of digital solutions with Digimax. Our cutting-edge technology and innovative approach empower businesses to thrive in the digital age. Join us on a journey of transformation and success.</p>
